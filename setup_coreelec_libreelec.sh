...
install_widevine()
{
  wget https://blog.vpetkov.net/wp-content/uploads/2019/08/libwidevinecdm.so_.zip -O $cdmpath/cdm.zip
  unzip -u $cdmpath/cdm.zip -d $cdmpath
}
...
get_kodi_addon_repo()
{
  ...
  wget -qN --show-progress $URL -O $userpath/$1
  echo $1
}
...
setup_kodi()
{
  ...
  unzip -u $userpath/addon_data/script.skinshortcuts.zip -d $userpath/addon_data/
